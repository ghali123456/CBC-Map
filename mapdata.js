var simplemaps_statemap_mapdata={
  main_settings: {
   //General settings
    ...
    backgroundmap_tiles_url: "https://cdn.simplemaps.com/pmtiles/state/SD.pmtiles",
  ...
  locations: {
    ...
    "5": {
      ...
      color: "gold",
      type: "star",
      url: "https://www.xixbrewingco.com"
    },
    "6": {
      lat: 42.745,
      lng: -96.827,
  ...
  regions: {
    "0": {
      states: [],
      name: "Louie’s Cleaning & Disaster Restoration"
    }
  }
};